...
namespace FR_WS2_BaseLab.Services.Implementations
{
	public class TopicService : ITopicService
	{
		...
		// Liste des sujets d'une catégorie (page Index).
		// Inclut User, Posts et Posts.User pour l'aperçu des messages.
		...
		// Détails d'un sujet (page Details).
		...
		// Création d'un sujet (POST Create).
		...
		// Modification d'un sujet (POST Edit).
		...
		// Suppression d'un sujet (POST Delete).
