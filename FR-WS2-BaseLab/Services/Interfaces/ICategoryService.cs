...
public interface ICategoryService
{
    ...
    Task<ServiceResult<Category>> CreateAsync(Category category, IFormFile? imageFile);
    Task<ServiceResult<Category>> UpdateAsync(int id, Category category, IFormFile? imageFile);
